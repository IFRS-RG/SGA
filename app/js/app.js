...
const App = {
  ...
  menu: [
    ...
    { id: 'selecao',      label: 'Seleção',      icon: '🧭', roles: ['Admin', 'Gestor', 'Visualizador'], module: 'Selecao' },
    ...
    { id: 'comissao',     label: 'Comissão',     icon: '🏛️', roles: ['Admin', 'Gestor', 'Visualizador'], module: 'Comissao' },
